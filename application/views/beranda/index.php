        ...
        <div class="container">
          ...
          <!-- Upcoming Event -->
                    <div class="text-center">
                        ...
                        <hr class="underline">
                            <!--<p style="font-size:30px;">NATAL PELKAT - PA</p>
                                <span style="font-size:20px;">GPIB "BAHTERA IMAN"
                                <br>Jl. Petunia Kav. 415A Bukit Nusa Indah
                                <br>Sabtu, 08 Desember 2018. Pkl: 16:00 wib s/d selesai
                                </span>-->
            </div>
        <div class="col-sm-6">
          ...
          <!-- Indicators -->
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="<?php echo base_url(); ?>assets/images/berkat.jpg" alt="">
              </div>
              <div class="item">
                <img src="<?php echo base_url(); ?>assets/images/prosesi.jpg" alt="">
              </div>
              <div class="item">
                <img src="<?php echo base_url(); ?>assets/images/jemaat.jpg" alt="">
              </div>              
              <div class="item">
                <img src="<?php echo base_url(); ?>assets/images/hut.jpg" alt="">
              </div>
              <div class="item">
                <img src="<?php echo base_url(); ?>assets/images/konsistori.jpg" alt="">
              </div>
